...
export default function Login() {
  ...
  const textosErro = {
    ...
    emailNaoVerificado:
      "Por favor, verifique seu e-mail para concluir o processo de registro, e assim poder realizar o login.",
  };
  ...
  return (
    <main className="login m-auto w-full mt-0 pt-10 h-[100vh]">
      <LoginForm
        formTitle="Login"
        formButton={isLoading ? "Carregando..." : "Login"}
        onSubmit={onSubmit}
        isLoading={isLoading}
      >
        <InputField
        ...
        <div className="signup-link">
          {loginFalse && <p className="texto-erro">{textosErro[loginFalse]}</p>}
          <p className="texto-normal">Ainda não possui uma conta?</p>
          <Link className="link" to="/cadastro">
            Registrar-se
          </Link>
          <Link className="link" to="/digitarEmail">
            esqueceu senha
          </Link>
        </div>
      </LoginForm>
